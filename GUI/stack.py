...
class Stack_():
    def __init__(self):
        ...
        self.mid_w, self.mid_h = self.wm.DISPLAY_W /2 , self.wm.DISPLAY_H/2 + 60
    ...
    def show_display(self):
        ...
        while running:
            ...
            if self.flag_input == "add":
                ...
                self.wm.draw_circle(self.node_positions[0][0], self.node_positions[0][1]-40, 24, self.wm.BLUE, 1)
                self.wm.blit_screen()   
    ...
    def check_input(self):
        ...
        for event in pygame.event.get():   
            ...
            if event.type == pygame.MOUSEBUTTONDOWN:
                    ...
                    elif self.wm.collide_point("imgs/enviar2.png",400, 840, mouse_position):
                    ...
                    elif self.wm.collide_point("imgs/enviar2.png",600, 840, mouse_position):
    ...
    def create_node(self, posx, posy, text, color_text, node_index):
        ...
        if node_index < self.list.qtd_elements-1:
            self.wm.draw_arrow(pygame.Vector2(posx, posy + 24), pygame.Vector2(posx, posy +48), self.wm.WHITE, 4, 10, 8)
    ...
    def print_static_imgs(self):
       ...
       self.wm.add_img("imgs/remover.png", 400, 780)  
       self.wm.add_img("imgs/buscar.png", 600, 780) 
       self.wm.add_img("imgs/elemento.png", 75, 775.5) 
      
       self.wm.add_img("imgs/enviar2.png", 200, 840)  #inserir button
       self.wm.add_img("imgs/enviar2.png", 400, 840)  #remover button
       self.wm.add_img("imgs/enviar2.png", 600, 840)  #consultar button
