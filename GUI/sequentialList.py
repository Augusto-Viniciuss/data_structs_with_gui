...
class SequentialList():
    def __init__(self):
        ...
        self.input_box3 = InputBox(self.box_x*2, self.box_y)
        self.input_box4 = InputBox(self.box_x*2, self.box_y+75)
        self.input_box5 = InputBox(self.box_x*3, self.box_y)
        self.input_box6 = InputBox(self.box_x*3, self.box_y+75)
    ...
    def show_display(self):
        ...
        while running: 
            ...
            self.wm.window.blit(text_surface, (self.box_x-150, self.box_y+5))  #in the left of the firstbox
            
            text_surface = font.render("por elemento:", True, self.wm.PURPLE)
            self.wm.window.blit(text_surface, (self.box_x-150, self.box_y+75+5))  #in the left of the second box
            ...
            self.wm.window.blit(text_surface, (self.box_x*2+15, self.box_y-30))  #in the top of second column
            self.input_box3.draw(self.wm.window)
            self.input_box4.draw(self.wm.window)
            
            text_surface = font.render("BUSCA", True, self.wm.PURPLE)
            self.wm.window.blit(text_surface, (self.box_x*3+20, self.box_y-30))  #in the top of third column
